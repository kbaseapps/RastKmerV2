...
function RastKmerV2(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.annotate_genes = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "RastKmerV2.annotate_genes",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "RastKmerV2.status",
